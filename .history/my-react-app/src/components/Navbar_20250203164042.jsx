...
const Navbar = () => {
  ...
  return (
    <nav className="relative">
      ...
      {/* Mobile Navigation */}
      <div className="md:hidden flex items-center justify-between pr">
        <motion.div
      ...
      {isMobileMenuOpen && (
        <motion.div
          ...
          exit={{ opacity: 0, y: -20 }}
          className="absolute top-full right-0 right-0 mt-2 bg-zinc-800 rounded-lg py-2 shadow-lg md:hidden w-1/2"
        >
          <button className="w-full text-left px-4 py-2 text-white hover:bg-[#653fd2]">
            Index
          </button>
          <button className="w-full text-left px-4 py-2 text-white hover:bg-[#653fd2]">
            News
