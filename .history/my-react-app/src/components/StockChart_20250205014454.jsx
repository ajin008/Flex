...
const StockChart = ({ stockData }) => {
  console.log("stock chart is working:", stockData);
  console.log("Chart data:", stockData?.data);

  // Check if stockData exists and has the required properties
  if (!stockData || !stockData.data) {
    return (
      <div className="w-[800px] h-[300px] bg-gradient-to-br from-[#1a2b3c] via-[#2c3e50] to-[#34495e] rounded-2xl overflow-hidden shadow-2xl flex items-center justify-center text-white">
  ...
  return (
    <div className="w-[400px] h-[300px] bg-gradient-to-br from-[#1a2b3c] via-[#2c3e50] to-[#34495e] rounded-2xl overflow-hidden shadow-2xl relative">
