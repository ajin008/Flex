...
import <div className="hidden md:flex space-x-2">
        ...
        <div className="md:hidden absolute top-full left-0 w-full bg-zinc-800 z-50">
          <div className="flex flex-col">
            ...
            <div className="flex flex-col space-y-2 px-4 py-3">
              <button className="w-full bg-purple-600 text-white text-sm px-4 py-2 rounded-full hover:bg-purple-700 transition-colors">
                Login
              </button>
              <button className="w-full bg-purple-600 text-white text-sm px-4 py-2 rounded-full hover:bg-purple-700 transition-colors">
                Sign in
