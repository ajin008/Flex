        ...
        {user ? (
          ...
          <div className="flex items-center space-x-2">
            <div className="group relative">
              <button className="flex items-center space-x-2 bg-purple-600 text-white px-4 py-1 rounded-full hover:bg-purple-700 transition-colors">
                <img
                  src={`http://localhost:12500${user.picture}`}
                  alt={user.name}
              ...
              {/* Dropdown menu */}
              <div className="hidden group-hover:block absolute right-0 mt-2 w-48 bg-btn3 rounded-lg shadow-lg py-1 z-50">
                <button
