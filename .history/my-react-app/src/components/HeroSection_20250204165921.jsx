...
const HeroSection = () => {
  ...
  return (
    <div className="relative overflow-hidden py-12">
      ...
      >
        <motion.h1 className="flex flex-wrap justify-center gap-x-2 text-4xl md:text-5xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-[#9112ed] to-[#0f1726]">
